...
static void initTextures() {
    ...
    Color zoneColors[4][2] = {
        {{28, 42, 74, 255}, {20, 32, 60, 255}},      // DEV - azul petróleo
        {{22, 52, 38, 255}, {16, 42, 28, 255}},      // DATA - verde oscuro
        {{48, 28, 65, 255}, {38, 20, 52, 255}},      // MEETING - púrpura
        {{58, 40, 20, 255}, {45, 30, 14, 255}}       // LOUNGE - marrón madera
    };
    ...
    // --- Rack servidor mejorado ---
    {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // LED verde parpadeante (simulado)
    ...
    // --- Lounge mejorado ---
    {
        ...
        // Maceta con planta más detallada
...
// ============================================================
// Mobiliario con texturas + sombra
// ============================================================
...
static void drawBackground(double time) {
    // Degradado vertical: azul oscuro arriba → casi negro abajo
...
// ============================================================
// Entity drawing (avatares) — mejorados
// ============================================================
static void drawEntity(const Entity& e, Vector2 pos) {
    ...
    // Indicador "disponible para charlar"
...
void drawScene(const std::vector<Entity>& entities, Vector2 origin, double time) {
    ...
    // 5. Luces de zona (pulsación sutil)
    for (int i = 0; i < 4; i++) {
        auto& z = zones[i];
    ...
    // 6. Entidades ordenadas por profundidad
